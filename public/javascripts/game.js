...
socket.onmessage = function (event) {
        ...
        console.log(oMsg.data[0]);
            ...
            if(oMsg.type == Messages.T_Set_Field){
                    ...
                    enemyShips = [smolship3, smolship4, mediumship3, mediumship4, largeship2];
            }
            ...
            if(oMsg.type == Messages.T_Shot){
                ...
                if(Id != 50){
                        ...
                        if(ships[index].includes(String(Id))){
                ...
                for(const right of rights){
                        if(!(shots.includes(Number(right.id))))
                        right.className -= ' disabled'
                }
                }
...
var main = function () {
    ...
    $(".rightField div").toArray().forEach(function (element) {
        ...
        $(element).on("click", function () {
            ...
            for(var index = 0; index < ships.length; index++){
                if(enemyShips[index].includes(String(id))){
                ...
                if(shots.includes(Number(smolship3[0])) && shots.includes(Number(smolship3[1]))){
                        alert("you sunk a small ship!")
                }
                if(shots.includes(Number(smolship4[0])) && shots.includes(Number(smolship4[1]))){
                        alert("you sunk a small ship!")
                }
                if(shots.includes(Number(mediumship3[0])) && shots.includes(Number(mediumship3[1])) && shots.includes(Number(mediumship3[2]))){
                        alert("you sunk a medium ship!")
                }
                if(shots.includes(Number(mediumship4[0])) && shots.includes(Number(mediumship3[1])) && shots.includes(Number(mediumship4[2]))){
                        alert("you sunk a medium ship!")
                }
                if(shots.includes(Number(largeship2[0])) && shots.includes(Number(largeship2[1])) && shots.includes(Number(largeship2[2])) && shots.includes(Number(largeship2[3]))){
                        alert("you sunk a large ship!")
                }
